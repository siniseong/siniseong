  ...
  template() {
    const experienceList = [
      ...
      },
      {
        ...
        descriptions: [
          '교내 AI SW 경진대회에서  우산 대여 시스템을 개발하여 장려상을 수상하였습니다. 재학 중인 학교는 기숙형 학교로 일요일 입소 날 우산을 챙겨오지 않는다면 금요일 비를 맞는 경우가 많았습니다. 이런 상황을 대비해 교내에서 사용할 수 있도록 우산 시스템을 개발하였고, 학생증을 사용해 우산 대여 및 반납이 가능합니다. 우산 사라짐과 같은 문제를 해결하기 위해서 대여자 목록을 선생님에게 보여줍니다.',
        ],
      },
      {
